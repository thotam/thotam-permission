    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content py-2">
            <div class="modal-header">
                <h4 class="modal-title text-indigo"><span class="fas fa-user-tag mr-3"></span>{{ $modal_title }}</h4>
                    ...
                    <div class="row">
                        ...
                        @if ($deleteStatus)
                            <div class="col-12 mb-3 text-danger font-weight-semibold">
                                Bạn sẽ Role có thông tin như sau, việc xóa là KHÔNG THỂ khôi phục,bạn có chắc chắn?
                            </div>
